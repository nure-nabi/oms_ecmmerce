class CategoryProductResModel{
  bool success;
  List<CategoryProductModel> products;
  CategoryProductResModel({required this.products,required this.success});

  factory CategoryProductResModel.fromJson(Map<String,dynamic> json){
    return CategoryProductResModel(
      success: json['success'] ?? false,
      products: json["products"] != null
          ? List<CategoryProductModel>.from(
          json["products"].map((x) => CategoryProductModel.fromJson(x)))
          : [],
    );
  }
}
