...
class ProductModel {
  ...
  ProductModel({required this.sell_price,required this.product_name, required this.image_full_url,required this.main_image_full_url});

  factory ProductModel.fromJson(Map<String,dynamic> json){
    return ProductModel(
        product_name: json['product_name'] ?? "",
         sell_price: json['sell_price'] == null ? "0.0" : json['sell_price'],
