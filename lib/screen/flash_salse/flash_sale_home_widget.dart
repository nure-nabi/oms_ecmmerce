...
import 'bloc/flash_sale_event.dart';
import 'flash_sales_page.dart';


class FlashSaleHomeWidget extends StatefulWidget {
  const FlashSaleHomeWidget({super.key});

  @override
  State<FlashSaleHomeWidget> createState() => _FlashSaleHomeWidgetState();
}

class _FlashSaleHomeWidgetState extends State<FlashSaleHomeWidget> {
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Icon(Icons.flash_on, size: 13, color: Colors.orange.shade600), // Match icon size to text
                        Text(
                          "h Sale",
                          style: GoogleFonts.poppins(
                         //   color: Color(0xff003466),
                        ...
                        Container(
                            ...
                            decoration: BoxDecoration(
                              gradient: LinearGradient(
                                ...
                                colors: [
                                  Colors.green.shade700,  // Darker red at the top
                                  Colors.orange,  // Lighter red at the bottom
                                ],
                              ),
                            )),
