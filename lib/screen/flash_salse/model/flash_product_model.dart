class FlashProductResModel{
  List<FlashProductModel> products;
  FlashProductResModel({required this.products});

  factory FlashProductResModel.fromJson(Map<String,dynamic> json){
    return FlashProductResModel(
      products: json["products"] != null
          ? List<FlashProductModel>.from(
          json["products"].map((x) => FlashProductModel.fromJson(x)))
          : [],
    );
  }
}
