class RandomProductRes{
  List<RandomProductModel> products;
  RandomProductRes({required this.products});

  factory RandomProductRes.fromJson(Map<String,dynamic> json){
    return RandomProductRes(
      products: json["products"] != null
          ? List<RandomProductModel>.from(
          json["products"].map((x) => RandomProductModel.fromJson(x)))
          : [],
    );
  }
}
