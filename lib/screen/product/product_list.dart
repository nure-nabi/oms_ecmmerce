...
import 'component/latest_product.dart';
...
class _ProductListPageState extends State<ProductListPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title:  Text("Product List",style: GoogleFonts.poppins(
          letterSpacing: 1
        ),),
        leading: InkWell(
          onTap: (){
                                          ...
                                          Positioned(
                                            ...
                                            child: InkWell(
                                              onTap: (){
                                                ...
                                                context.read<ProductListBloc>().add(ProductWishListUpdateEvent(index: index,flag: true,limit: 20));
                                              },
                                              child: Icon(
                                                info.is_wishlisted!?
...
class ProductAllItem extends StatelessWidget {
  final LatestProductModel latestProductModel;
  final String name;
  final String brand;
  final String price;
