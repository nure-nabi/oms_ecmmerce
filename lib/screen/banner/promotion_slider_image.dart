...
import 'package:oms_ecommerce/screen/banner/banner_bloc/promotion_bloc/promotion_bloc.dart';
...
import 'banner_bloc/promotion_bloc/promotion_event.dart';
import 'banner_bloc/promotion_bloc/promotion_state.dart';



class PromotionSliderImage extends StatefulWidget {
  const PromotionSliderImage({super.key});

  @override
  State<PromotionSliderImage> createState() => _PromotionSliderImageState();
}
    ...
    return Container(
      ...
      child: BlocBuilder<PromotionBloc,PromotionState>(builder: (BuildContext context, state) {
        if(state is PromotionLoadingState){
          ...
          if( state.promotionRes!.banners.isNotEmpty){
